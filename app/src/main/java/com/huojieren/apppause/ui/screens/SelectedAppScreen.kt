...
@Composable
fun SelectedAppScreen(
    modifier: Modifier = Modifier,
    uiState: SelectAppUiState,
    onToSelectingApp: () -> Unit,
    onDeleteAppItem: (AppInfoUi) -> Unit,
) {
    Surface(
        ...
        Column(
            ...
            if (uiState.monitoredApps.isEmpty()) {
                ...
                AppList(
                    appList = uiState.monitoredApps,
                    onDeleteApp = { onDeleteAppItem(it) }
                )
            }
        }
    }
